...
public class LabResultService {
    ...
    private LabResult createLabResult(User tester, TestRequest testRequest) {
        LabResult createLabResult = new LabResult();

        createLabResult.setTester(tester);

        createLabResult.setRequest(testRequest);

        return saveLabResult(createLabResult);
    ...
    public LabResult updateLabTest(TestRequest testRequest, CreateLabResult createLabResult) {
        ...
        labResult.setUpdatedOn(createLabResult.getUpdateOn());
        labResult.setResultId(testRequest.getLabResult().getResultId());
