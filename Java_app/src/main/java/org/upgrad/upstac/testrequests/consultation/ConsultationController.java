...
public class ConsultationController {
    ...
    @GetMapping("/api/consultations/in-queue")
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        RequestStatus requestStatus=RequestStatus.LAB_TEST_COMPLETED;
    ...
    @PreAuthorize("hasAnyRole('DOCTOR')")
    @PutMapping("/api/consultations/assign/{id}")
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest assign = testRequestUpdateService.assignForConsultation(id,user);
            return assign;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User user=userLoggedInService.getLoggedInUser();
            TestRequest updateResult=testRequestUpdateService.updateConsultation(id,testResult,user);
            return updateResult;
