...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        //Act
        testRequest1=consultationController.assignForConsultation(testRequest.requestId);

        //Assert

        assertThat(testRequest1.requestId, Matchers.comparesEqualTo(testRequest.requestId));
        assertThat(testRequest1.getStatus(),Matchers.equalTo(RequestStatus.DIAGNOSIS_IN_PROCESS));
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_throw_exception(){
        ...
        assertThat(result.getMessage(),Matchers.containsString("Invalid ID"));
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        testRequest1=consultationController.updateConsultation(testRequest.requestId,consultationRequest);

        //Assert

        assertThat(testRequest.requestId,Matchers.equalTo(testRequest1.requestId));
        assertThat(testRequest1.getStatus(),Matchers.equalTo(RequestStatus.COMPLETED));
        assertThat(testRequest.getConsultation().getSuggestion(),Matchers.equalTo(testRequest1.getConsultation().getSuggestion()));
    ...
    public void calling_updateConsultation_with_invalid_empty_status_should_throw_exception(){
        ...
        assertThat(result.getMessage(),Matchers.containsString("ConstraintViolationException"));
