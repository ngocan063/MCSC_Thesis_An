...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        testRequest1=labRequestController.assignForLabTest(testRequest.requestId);

        //Assert

        assertThat(testRequest1.requestId, Matchers.comparesEqualTo(testRequest.requestId));
        assertThat(testRequest1.getStatus(),Matchers.equalTo(RequestStatus.LAB_TEST_IN_PROGRESS));
    ...
    public void calling_updateLabTest_with_valid_test_request_id_should_update_the_request_status_and_update_test_request_details(){
        ...
        testRequest1=labRequestController.updateLabTest(testRequest.requestId,labResult);

        //Assert

        assertThat(testRequest.requestId,Matchers.equalTo(testRequest1.requestId));
        assertThat(testRequest1.getStatus(),Matchers.equalTo(RequestStatus.LAB_TEST_COMPLETED));
        assertThat(testRequest.getLabResult().getResult(),Matchers.equalTo(testRequest1.getLabResult().getResult()));
